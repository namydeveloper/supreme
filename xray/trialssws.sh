...
shadowsockslink2="ss://${shadowsocks_base64e}@isi_bug_disini:80?path=ss-ws&security=tls&host=${domain}&type=ws#${user}"
...
echo "killtrial ssws ${user}" | at now +60 minutes &> /dev/null
